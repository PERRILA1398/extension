...
public class HomePage extends Utils {
    ...
    public String expectedhoverColour= "rgba(74, 178, 241, 1)";
    ...
    public void hoverovercategorybutton(String categoryName) {
        ...
        System.out.println("Before hover colour of category" + element.getCssValue("color"));

        Actions actions = new Actions(driver);

        actions.moveToElement(element).perform();

        System.out.println("After hover colour pf category" + element.getCssValue("color"));

         //Assert.assertEquals(element.getCssValue("color"),expectedhoverColour);
